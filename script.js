...
(function initThree() {
    ...
    Promise.all([
        webgl.texture,
        webgl.loader.load('https://i.ibb.co/h166sC7/bubble-show-png.png'),
        webgl.loader.load('https://i.ibb.co/G7hqDR0/boy.png'),
        loadAsync("https://i.imgur.com/FyHLAY8.mp4"),
        webgl.loader.load('https://i.ibb.co/RjjfRYn/4.jpg'),
        webgl.loader.load('https://i.ibb.co/MR77X9h/community.jpg'),
        webgl.loader.load('https://i.ibb.co/DgM26TJ/competation.png'),
        webgl.loader.load('https://i.ibb.co/Vvrh0PV/golf.png'),
        webgl.loader.load('https://i.ibb.co/gmqskYk/kids.png'),
        webgl.loader.load('https://i.ibb.co/bvHW1h8/mountain.png'),
        webgl.loader.load('https://i.ibb.co/m0623ht/10.jpg'),
        webgl.loader.load('https://i.ibb.co/YhRRPCt/paddlebat.png'),
        webgl.loader.load('https://i.ibb.co/tJ7JymT/national-day.png'),
        ...
        loadAsync("https://i.imgur.com/ivH8pA4.mp4"),
        webgl.loader.load('https://i.ibb.co/FX4bL6Z/16.jpg'),
        loadAsync("https://i.imgur.com/Eq17Aai.mp4"),
        webgl.loader.load('https://i.ibb.co/dbwc01m/bday-gal.png'),
        webgl.loader.load('https://i.ibb.co/b56bX8t/paddle.png'),
        webgl.loader.load('https://i.ibb.co/Qm2XCRG/baby.png'),
        webgl.loader.load('https://i.ibb.co/vwZbnmG/pushup.png'),
        loadAsync("https://i.imgur.com/Bm7WdGD.mp4"),
        loadAsync("https://i.imgur.com/eC1nmy0.mp4"),
        loadAsync("https://i.imgur.com/N0XnaNd.mp4"),
        webgl.loader.load('https://i.ibb.co/2MF0QCr/golf2.png'),
    ...
    webgl.texturesOptions = [
        ...
        { index: 3, texture: "video", quote: '“Be the change you want to see, <span style="color:#a87171; font-style: italic;"> in the world.</span>”', threshold: 100, random: 2.0, depth: 2.0, maxDepth: 60, size: 1.5, square: 0 },
        ...
        { index: 5, texture: "image", quote: 'You miss 100% of the <span style="color:#c89c5b">shots</span> you dont take!', threshold: 30, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        { index: 6, texture: "image", quote: 'The best time to plant a tree was <span style="color:#f14646">20 years ago</span>, the second best time is now', threshold: 30, random: 2.0, depth: 3.0, size: 1.0, square: 1 },
        ...
        { index: 8, texture: "image", quote: '“Whatever the mind of a man concieve and beleive <span style="color:#f4852a">it can achive.</span>“', threshold: 20, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        { index: 9, texture: "image", quote: 'oppurtunities dont happen <span style="color:#C32B59">you</span> create them.', threshold: 20, random: 2.0, depth: 8.0, size: 1.5, square: 0, a2: true },
        ...
        { index: 11, texture: "image", quote: 'It is never too late to be<br> <span style="font-style: italic; color:#f91a1a">what you might have been</span>', threshold: 60, random: 2.0, depth: 2.0, maxDepth: 80, size: 1.5, square: 0, color: "transparent", stagger: 1 },
        { index: 12, texture: "image", quote: '“Learn as if you will live forever,  <span style="color:#f3ee62">live like you will die tomorrow.</span>”', threshold: 60, random: 2.0, depth: 4.0, maxDepth: 60, size: 1.5, square: 0 },
        { index: 13, texture: "video", quote: '“ It is better to fail in <span style="color:#f91a1a">originality</span> than to succeed in imitation ” <span style="font-style: italic; font-size: 1.5vw; color:#f77e7e"> Herman Melville</span>', threshold: 60, random: 2.0, depth: 15.0, maxDepth: 120, size: 2.0, square: 0, stagger: 1 },
        { index: 14, texture: "image", quote: '“Success usually comes to those <br> who are too busy  <span style="font-style: italic; color:#c8664c"> looking </span> for it. ”', threshold: 20, random: 2.0, depth: 4.0, maxDepth: 180, size: 1.5, square: 0 },
        ...
        { index: 24, texture: "image", quote: '“Goal setting <span style="color:#ea1f66"> is the secret</span> to a compelling future!”', threshold: 10, random: 2.0, depth: 4.0, size: 1.5, square: 0 },
        { index: 25, texture: "image", quote: '“ Either you run the day <span style="color:#ec1713">or</span> the day runs you.“', threshold: 20, random: 2.0, depth: 4.0, size: 1.5, square: 0, a1: true },
